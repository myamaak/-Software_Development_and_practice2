      ...
      if($count == 1) {
        ...
        if(isset($_COOKIE['login'])){
         ...
         if($_COOKIE['login'] < 3){
           ...
           echo '3 failed attempts at logging in and now are banned for 10 minutes. Try again later!';
           $val="disabled";
         }
       } else {
         ...
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "post" >
                  <label>User ID  :</label><input type = "text" name = "userID" <?php echo $val; ?> /><br /><br />
